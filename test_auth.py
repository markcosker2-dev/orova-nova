...
try:
    r = httpx.get('http://127.0.0.1:18789/api/health')
...
try:
    r = httpx.get('http://127.0.0.1:18789/api/health', headers={'X-API-Key': 'wrong'})
...
# Use: nova_admin_2026
try:
    r = httpx.get('http://127.0.0.1:18789/api/health', headers={'X-API-Key': 'nova_admin_2026'})

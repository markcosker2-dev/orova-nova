...
export function Sidebar() {
  ...
  const coreNavItems = [
    ...
    { to: '/dashboard', icon: <Cpu className="h-[18px] w-[18px]" strokeWidth={2} />, label: t('sidebar.orovaDashboard'), testId: 'sidebar-nav-dashboard' },
    { to: '/leads', icon: <ShieldCheck className="h-[18px] w-[18px]" strokeWidth={2} />, label: t('sidebar.leadPipeline'), testId: 'sidebar-nav-leads' },
    { to: '/office', icon: <Users className="h-[18px] w-[18px]" strokeWidth={2} />, label: t('sidebar.orovaOffice'), testId: 'sidebar-nav-office' },
  ];
      ...
      <div className={cn("flex items-center p-2 h-12", sidebarCollapsed ? "justify-center" : "justify-between")}>
        {!sidebarCollapsed && (
          <div className="flex items-center gap-2 px-2 overflow-hidden">
              <img src={logoPng} alt="HermesClaw" className="h-5 w-auto shrink-0" />

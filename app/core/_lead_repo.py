    ...
    def save_lead(cls, lead: dict, default_vertical: str = None, client_id: int = 0) -> int:
        ...
        with cls.connection() as conn:
            try:
                ...
                cursor = conn.execute(
                    """INSERT INTO leads (business, owner, url, website, email, phone, vertical, status, notes, icebreaker, score, client_id, email_status, owner_title, linkedin_url, owner_source, email_source, phone_source, phone_verified, owner_confidence, evidence_json, updated_at)

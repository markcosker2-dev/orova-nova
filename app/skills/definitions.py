        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "rows": {'type': 'array', 'items': {'type': 'array', 'items': {'type': 'string'}}, 'description': 'List of rows to append.'},
                },
    ...
    },
{
        ...
        "function": {
            "name": "browse_agent",
            "description": "Advanced browsing agent that can interact with a page (scroll, click, extract). Replaces read_webpage.",
            "parameters": {
                "type": 'object',
                "properties": {
                    "url": {'type': 'string', 'description': 'The URL to visit', 'pattern': '^https?:\\/\\/(?:www\\.)?[-a-zA-Z0-9@:%._\\+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b(?:[-a-zA-Z0-9()@:%_\\+.~#?&\\/=]*)$'},
                    "objective": {'type': 'string', 'description': "What you want to achieve on this page. For simple reading, say 'Extract main text'.", 'minLength': 5},
                },
                "required": ['url', 'objective'],
    ...
    },
{
        ...
        "function": {
            ...
            "parameters": {
                "type": 'object',
                "properties": {
                    "prospect": {'type': 'object', 'description': 'Prospect dict with keys: first_name, company, industry, location, email', 'properties': {'first_name': {'type': 'string'}, 'company': {'type': 'string'}, 'industry': {'type': 'string'}, 'location': {'type': 'string'}, 'email': {'type': 'string'}}},
    ...
    },
{
        ...
        "function": {
            ...
            "parameters": {
                "type": 'object',
                "properties": {
                    "lead_data": {'type': 'object', 'description': 'Dict containing lead data keys: business, owner, email, phone, website, url, status, score, notes.'},
                },
                "required": ['lead_data'],
            },
        }
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "increment": {'type': 'number', 'minimum': 0.01, 'maximum': 100000, 'default': 1},
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "context": {'type': 'object', 'properties': {'business_name': {'type': 'string'}, 'icebreaker': {'type': 'string'}}},
                },

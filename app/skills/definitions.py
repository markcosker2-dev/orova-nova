...
TOOLS = [
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "objective": {
                        "type": "string", 
                        "description": "What you want to achieve on this page. For simple reading, say 'Extract main text'.",
                        "minLength": 5
                    }
                },
    ...
    # ─── STEALTH SCRAPING (Viper) — OpenClaw Ecosystem ─────────────────
    {
        "type": "function",
        "function": {
            "name": "stealth_search",
    ...
    # ─── DRIP CAMPAIGNS (Quill) — OpenClaw Ecosystem ───────────────────
    {
        "type": "function",
        "function": {
    ...
    # ─── COPYWRITING (Quill) — OpenClaw Ecosystem ──────────────────────
    {
        "type": "function",
        "function": {
    ...
    # ─── ANALYTICS (Oracle) — OpenClaw Ecosystem ───────────────────────
    {
        "type": "function",
        "function": {
    ...
    # ─── PIPELINE ORCHESTRATION — OpenClaw Ecosystem ───────────────────
    {
        "type": "function",
        "function": {
            "name": "run_pipeline",

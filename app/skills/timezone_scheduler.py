...
def get_timezone_from_state(state_abbr: str = None, country: str = "US") -> Optional[str]:
    ...
    # Resolved duplicate "CT" collision. Connecticut "CT" matches Eastern Time Zone America/New_York.
    # Central Time States (TX, OK, KS, etc.) are matched directly by their state codes.
    us_tz_map = {
        ...
        "TX": "America/Chicago", "OK": "America/Chicago", "KS": "America/Chicago", "NE": "America/Chicago", "SD": "America/Chicago", "ND": "America/Chicago", "MN": "America/Chicago", "IA": "America/Chicago", "MO": "America/Chicago", "AR": "America/Chicago", "LA": "America/Chicago",
        "ET": "America/New_York", "CT": "America/New_York", "ME": "America/New_York", "VT": "America/New_York", "NH": "America/New_York", "MA": "America/New_York", "RI": "America/New_York", "NY": "America/New_York", "PA": "America/New_York", "NJ": "America/New_York", "DE": "America/New_York", "MD": "America/New_York", "VA": "America/New_York", "WV": "America/New_York", "OH": "America/New_York", "MI": "America/New_York", "IN": "America/New_York", "KY": "America/New_York", "TN": "America/New_York", "NC": "America/New_York", "SC": "America/New_York", "GA": "America/New_York", "FL": "America/New_York",
    }

...
TOOLS = [
    ...
    # ─── APOLLO LEADS (Apify) ──────────────────────────────────────────
    {
        "type": "function",
        "function": {
            "name": "quick_founders_us_50",
            "description": "Run preset for 50 US founders with verified emails using Apify actor.",
            "parameters": {"type": "object", "properties": {}}
        }
    },
    {
        "type": "function",
        "function": {
            "name": "run_apollo_leads",
            "description": "Run custom Apollo-like B2B leads collection with specified payload.",
            "parameters": {
                "type": "object",
                "properties": {
                    "payload": {"type": "object", "description": "JSON payload for Apify actor (e.g., max_results, job_titles, etc.)"}
                },
                "required": ["payload"]
            }
        }
    },
    {
        ...
        "function": {
            "name": "enrich_lead",
            "description": "Enrich lead data using Apify (placeholder for future AI enrichment).",
            "parameters": {
                "type": "object",
                "properties": {
                    "lead_data": {"type": "object", "description": "Lead data to enrich"}
                },
                "required": ["lead_data"]
            }
        }

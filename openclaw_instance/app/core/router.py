...
class Router:
    """
    OROVA Smart Router.
    Priority: Shortcuts -> AI Planner (Nova)
    """
    ...
    async def route(self, message: str, chat_id: int, history: list = None, status_callback=None):
        """
        ...
        return await self.planner.execute(message, client_id=chat_id, conversation_history=history, status_callback=status_callback)

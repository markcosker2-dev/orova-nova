...
Built for autonomous multi-step business workflows.
...
async def _execute_skill(skill_name: str, args: dict):
    ...
    skill_map = {
        ...
        "quick_founders_us_50": ("app.skills.apollo_leads", "quick_founders_us_50"),
        "run_apollo_leads": ("app.skills.apollo_leads", "run_custom_leads"),
        "enrich_lead": ("app.skills.apollo_leads", "enrich_lead"),
    }

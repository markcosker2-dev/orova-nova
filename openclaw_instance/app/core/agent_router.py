...
AGENTS = {
    ...
    "hawk": {
        "name": "HAWK",
        "role": "Lead Qualification & Outreach Director",
        "dept": "Business Operations",
        "skills": ["hawk_lead_scoring", "hawk_outreach", "hawk_insights"],
        "keywords": ["hawk", "qualify", "leads", "luxury", "outreach", "score", "alignment", "85", "threshold"],
    },
    "cashclaw": {
        "name": "CashClaw",
        "role": "Business Operations Manager",
        "dept": "Revenue",
        "skills": ["seo_audit", "lead_generation", "content_creation", "email_outreach", "competitor_analysis", "data_scraping", "landing_page", "reputation_audit", "proposal_generation", "invoice_creation"],
        "keywords": ["business", "revenue", "seo", "content", "leads", "outreach", "invoice", "proposal", "cashclaw", "monetize", "marketplace", "hyrve"],
    },
}

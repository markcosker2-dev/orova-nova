...
export const PROVIDER_DEFINITIONS: ProviderDefinition[] = [
  ...
  },
  {
    ...
    name: 'AWS Bedrock',
    icon: '🟧',
    placeholder: 'Uses AWS credentials',
    model: 'Bedrock',
    ...
    showBaseUrl: true,
    showModelId: true,
    modelIdPlaceholder: 'anthropic.claude-sonnet-4-5-20250929-v1:0',
  ...
  },
  {
    ...
    providerConfig: {
      ...
      headers: {
        'HTTP-Referer': 'https://github.com/NextAgentX/HermesClaw',
        'X-Title': 'HermesClaw',
      },
    },
  },
  {
    ...
    providerConfig: {
      ...
      models: [
        { id: 'gpt-4o', name: 'GPT-4o', cost: { input: 0, output: 0 } },
        { id: 'gpt-4o-mini', name: 'GPT-4o mini', cost: { input: 0, output: 0 } },
        { id: 'gpt-4.1', name: 'GPT-4.1', cost: { input: 0, output: 0 } },
        { id: 'gpt-4', name: 'GPT-4', cost: { input: 0, output: 0 } },
        { id: 'claude-3.5-sonnet', name: 'Claude 3.5 Sonnet', cost: { input: 0, output: 0 } },
        { id: 'claude-3.7-sonnet', name: 'Claude 3.7 Sonnet', cost: { input: 0, output: 0 } },
        { id: 'claude-sonnet-4', name: 'Claude Sonnet 4', cost: { input: 0, output: 0 } },
        { id: 'o1', name: 'o1', reasoning: true, cost: { input: 0, output: 0 } },
        { id: 'o3-mini', name: 'o3 mini', reasoning: true, cost: { input: 0, output: 0 } },
        { id: 'o4-mini', name: 'o4 mini', reasoning: true, cost: { input: 0, output: 0 } },
        { id: 'gemini-2.0-flash', name: 'Gemini 2.0 Flash', cost: { input: 0, output: 0 } },

...
export function createMenu(): void {
   ...
   const appName = app?.getName?.() ?? 'HermesClaw';
      ...
      submenu: [
        {
          label: 'Documentation',
          click: async () => {
            await shell.openExternal('https://github.com/NextAgentX/HermesClaw');
          },
        },
        {
          label: 'Report Issue',
          click: async () => {
            await shell.openExternal('https://github.com/NextAgentX/HermesClaw/issues');
          },
        },
        { type: 'separator' },
        {

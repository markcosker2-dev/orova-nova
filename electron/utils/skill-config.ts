...
interface PreinstalledMarker {
    source: 'hermesclaw-preinstalled';
    slug: string;
    version: string;
    installedAt: string;
}
...
/**
 * Built-in skills bundled with HermesClaw that should be pre-deployed to
...
const PREINSTALLED_MARKER_NAME = '.hermesclaw-preinstalled.json';

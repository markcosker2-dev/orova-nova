#!/usr/bin/env node
/**
 * Generates extension bridge files based on hermesclaw-extensions.json and
...
const MANIFEST_PATH = resolve(ROOT, 'hermesclaw-extensions.json');
...
function generateMainBridge(manifest) {
  ...
  if (installedExts.length === 0) {
    return [
      ...
      '// To add extensions, configure hermesclaw-extensions.json and link the package.',

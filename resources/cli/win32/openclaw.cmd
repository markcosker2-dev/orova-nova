...
if /i "%1"=="update" (
    echo openclaw is managed by HermesClaw ^(bundled version^).
    echo.
    echo To update openclaw, update HermesClaw:
    echo   Open HermesClaw ^> Settings ^> Check for Updates
    echo   Or download the latest version from https://github.com/NextAgentX/HermesClaw
    exit /b 0
)
...
set OPENCLAW_EMBEDDED_IN=HermesClaw
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\HermesClaw.exe" "%OPENCLAW_ENTRY%" %*
)

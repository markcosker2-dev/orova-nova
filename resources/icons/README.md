...
|------|----------|-------------|
| `../../logo.png` | Source | PNG source for all generated icons |
...
- Run: `iconutil -c icns -o icon.icns HermesClaw.iconset`
...
- **Design**: Simplified monochrome version of main icon (HermesClaw logo)
...
1. Replace the root `logo.png` source image
